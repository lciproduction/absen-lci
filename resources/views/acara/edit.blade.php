        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                ...
                <x-card.card-default
                    ...
                    <x-form action="{{ route('acara.update', $acara->id) }}" method="POST"
                        class="md:grid md:grid-cols-3 gap-4" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="mt-4">
                            ...
                            <x-input.text-input id="name" class="mt-1 w-full" type="text" name="name"
                                :value="old('name', $acara->name)" required autofocus autocomplete="name" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-input.text-input id="description" class="mt-1 w-full" type="text" name="description"
                                :value="old('description', $acara->description)" required autofocus autocomplete="description" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-input.text-input id="tanggal_pelaksanaan" class="mt-1 w-full" type="date"
                                name="tanggal_pelaksanaan" :value="old('tanggal_pelaksanaan', $acara->tanggal_pelaksanaan)" required autofocus
