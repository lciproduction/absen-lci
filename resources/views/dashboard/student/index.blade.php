        ...
        <div class="w-full mx-auto sm:px-6 lg:px-8 ">
            <x-card.card-default
                ...
                <div class="flex justify-start space-x-4">
                    <div class="mt-4">
                        <x-input.select-input id="divisi"
                            class="mt-1 w-full bg-red-primary text-white border border-white" name="divisi">
                            <option value="All">Semua</option>
                            <option value="Project Management">Project Management</option>
                            <option value="Community and Corporate Relations">Community and Corporate Relations</option>
                            <option value="Government and Stakeholder Relations ">Government and Stakeholder Relations
                            </option>
