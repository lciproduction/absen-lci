    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div>
              ...
              <x-card.card-default class="static bg-gradient-to-tr from-red-950 to-red-700 shadow-inner shadow-yellow-500 mx-auto mt-5">
                ...
                <x-form action="{{ route('student.store') }}" class="md:grid md:grid-cols-2 gap-4"
                    ...
                    <div class="mt-4">
                        <x-input.input-label for="name" class="text-white" :value="__('Nama Mahasiswa')" />
                            ...
                            @foreach($days as $day)
                                <div class="form-control">
                                    <label class=" cursor-pointer ">
                                        ...
                                        <span class="label-text text-[16px] text-white pl-2">{{ $day->name }}</span>
                                    </label>
                                </div>
                            @endforeach
                        </div>
