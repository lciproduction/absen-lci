...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-card.card-default
                class="static mx-auto bg-gradient-to-tr from-red-primary to-red-secondary shadow-lg border-4 border-white">
                ...
                <div class="flex justify-start space-x-4">
                    <x-form id="export-form" action="{{ route('attendance.export') }}" enctype="multipart/form-data">
                        ...
                        <button class="bg-red-secondary btn text-white" id="export-button" type="submit">
                            Export
                        </button>
                    </x-form>
                    <div>
                        <a href="{{ route('attendance.check_absentees') }}"><button
                                class="bg-red-secondary btn text-white w-full">
                ...
                <div class="flex flex-col lg:flex-row justify-start lg:space-x-4">
                    <div class="mt-4">
                        <x-input.text-input id="from"
                            class="mt-1 w-full bg-red-primary text-white border border-white" type="date"
                            name="from" required />
                    </div>
                    <div class="mt-4">
                        <x-input.text-input id="to"
                            class="mt-1 w-full bg-red-primary text-white border border-white" type="date"
                            name="to" required />
                    </div>
                </div>
    ...
    <style>
        ...
        [name="attendances_length"] {
            ...
            color: white !important;
            /* Supaya teks terlihat jelas di latar belakang merah */
        }
        ...
        .select2-container .select2-search--inline .select2-search__field::placeholder {
            ...
            /* Placeholder berwarna abu terang */
        }
        ...
        .dt-length select:focus {
            ...
            /* Ubah warna border menjadi merah */
            box-shadow: 0 0 0 2px #73c2fb !important;
            /* Shadow merah untuk konsistensi tema */
        }
