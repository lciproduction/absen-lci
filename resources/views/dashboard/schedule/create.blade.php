@section('title', 'Tambah Data Jadwal Mapel')
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-card.card-default class="static">
                ...
                <x-form action="{{ route('schedule.store') }}" class="md:grid md:grid-cols-2 gap-4"
                    ...
                    <div class="mt-4">
                        ...
                        <x-input.text-input id="time_in" class="mt-1 w-full" type="time" name="time_in"
                            :value="old('time_in')" required autofocus autocomplete="time_in" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-input.text-input id="time_out" class="mt-1 w-full" type="time" name="time_out"
                            :value="old('time_out')" required autofocus autocomplete="time_out" />
