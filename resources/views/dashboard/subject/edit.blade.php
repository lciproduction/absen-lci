    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-card.card-default class="static">
                ...
                <x-form action="{{ route('subject.update', $subject->id) }}" class="md:grid md:grid-cols-2 gap-4"
                    ...
                    <div class="mt-4">
                        ...
                        <x-input.text-input id="description" class="mt-1 w-full" type="text" name="description"
                            :value="old('description', $subject->description)" required autofocus autocomplete="description" />
