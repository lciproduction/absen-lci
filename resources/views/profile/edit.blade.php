...
<x-app-layout>
    ...
    <div class="h-full py-12 p-2 ">
        ...
        <div class="my-4 ">
            <div class=" w-[97%] lg:w-[90%] mx-auto flex flex-col 2xl:w-1/3 bg-gradient-to-tr from-red-950 to-red-700 shadow-inner shadow-yellow-500 text-white  rounded-xl py-5 space-y-5">
