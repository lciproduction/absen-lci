    ...
    <div class="py-12">
        <div class="flex justify-between items-center px-5">
            <a href="{{ route('student.history.index') }}">
                <button
                    class="btn bg-gradient-to-tr from-red-primary to-red-secondary shadow-inner shadow-white text-white">
            ...
            @if ($currentTime->between($timeInEarly, $timeInLate) || $currentTime->between($timeOutEarly, $timeOutLate))
                <x-button.danger-button class="btn bg-red-800 text-white" onclick="my_modal_1.showModal()">
        ...
        <div class="static overflow-x-auto mx-auto px-5 mt-10">
            ...
            <div
                class="stats w-full text-white bg-gradient-to-tr from-red-primary to-red-secondary shadow-inner shadow-white">

                <div class="stat place-items-center">
                    <div class="stat-title text-lg text-[#FFF100]">Biodata</div>
                ...
                <div class="stat place-items-center">
                    <div class="stat-title text-lg text-[#FFF100]">Status</div>
                ...
                @if ($attendance->status == 'Izin' || $attendance->status == 'Sakit')
                    ...
                    <div class="stat place-items-center">
                        <div class="stat-title text-lg text-[#FFF100]">Keterangan</div>
