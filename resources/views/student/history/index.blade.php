...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-card.card-default
                class="static mt-8 mx-auto bg-gradient-to-tr from-red-primary to-red-secondary shadow-lg border-4 border-white">
                                ...
                                if (full.status == 1) {
                                   ...
                                   <div class="flex justify-center items-center">
                                     <a href="{{ url('/siswa/history/${full.id}') }}">
                                        <button type="button" class="btn btn-sm text-white bg-gradient-to-tr from-red-primary to-red-secondary "><i class="fa-regular fa-eye"></i></button>
                                    </a>
                                    </div>
                                `;
                                }
